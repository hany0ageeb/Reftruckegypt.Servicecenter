namespace Reftruckegypt.Servicecenter.Models.Validation
{
    ...
    public class ExternalRepairBillValidator : IValidator<ExternalRepairBill>
    {
        public ModelState Validate(ExternalRepairBill externalRepairBill)
        {
            ...
            if(externalRepairBill.KilometerReading.HasValue && externalRepairBill.KilometerReading < 0)
            {
                modelState.AddError(nameof(externalRepairBill.KilometerReading), "Negative Kilometer Reading.");
            }
            return modelState;
        }
    }
